...
function getMiddleCharacter(str) {
  ...
  // Add your code here!
  /* Wow!  I did like... 3 cycles of refactoring on this to make it work and it ran! */
  /* It doesn't look too terribly readable to me tho! */
...
function reverseWord(word) {
  if (word === undefined) throw new Error("word is required");
  // Add your code here!
  /* I feel like I cheated on this one, but after refactoring, its all mine, yeah? */
